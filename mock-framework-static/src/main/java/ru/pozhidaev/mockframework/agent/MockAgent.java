package ru.pozhidaev.mockframework.agent;
...
import ru.pozhidaev.mockframework.staticmock.StaticMethodStub;

public final class MockAgent {
    private static final String PROJECT_PACKAGE_PREFIX = "ru.pozhidaev.mockframework.";
        ...
        new AgentBuilder.Default()
            ...
            .ignore(
                ElementMatchers.nameStartsWith("net.bytebuddy.")
                    ...
                    .or(ElementMatchers.nameStartsWith("ru.pozhidaev.mockframework.agent."))
                    .or(ElementMatchers.nameStartsWith("ru.pozhidaev.mockframework.staticmock."))
                    .or(ElementMatchers.nameStartsWith("ru.pozhidaev.mockframework.core."))
                    .or(ElementMatchers.named("ru.pozhidaev.mockframework.Mockito"))
                    .or(ElementMatchers.named("ru.pozhidaev.mockframework.MockedStatic"))
                    .or(ElementMatchers.named("ru.pozhidaev.mockframework.OngoingStubbing"))
                    .or(ElementMatchers.named("ru.pozhidaev.mockframework.StaticInvocation"))
